...
class encoder5(nn.Module):
  ...
  def forward(self,x,sF=None,contentV256=None,styleV256=None,matrix11=None,matrix21=None,matrix31=None):
    ...
    output['c12'] = self.conv3(out)
    output['r12'] = self.relu3(output['c12'])
    ...
    output['c22'] = self.conv5(out)
    output['r22'] = self.relu5(output['c22'])
    ...
    output['c32'] = self.conv7(out)
    output['r32'] = self.relu7(output['c32'])
    ...
    output['c42'] = self.conv11(out)
    output['r42'] = self.relu11(output['c42'])
